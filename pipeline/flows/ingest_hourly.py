...
from shared.weather_client import fetch_weather_current
...
def fetch_weather_readings():
    """Fetch current-hour weather observation for every gauge."""
    for gauge_cfg in GAUGES:
        hour = fetch_weather_current(lat=gauge_cfg["lat"], lon=gauge_cfg["lon"])
